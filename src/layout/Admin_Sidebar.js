		...
		<ul className="nav flex-column">
			...
			<li className="nav-item">
				<NavLink className="nav-link" to="/admin/waterfall"
					activeClassName="active"> Waterfall </NavLink>
			</li>
			<li className="nav-item">
			...
			<li className="nav-item">
				<NavLink className="nav-link" to="/admin/quoridor"
					activeClassName="active"> Quoridor </NavLink>
			</li>
			<li className="nav-item">
				<NavLink className="nav-link" to="/admin/text-editor"
					activeClassName="active"> Text Editor </NavLink>
			</li>
			<li className="nav-item">
				<NavLink className="nav-link" to="/admin/tools"
					activeClassName="active"> Tools </NavLink>
			</li>
			<li className="nav-item">
				<NavLink className="nav-link" to="/" exact
					activeClassName="active"> Back to Home page </NavLink>
			</li>
		</ul>
	</div>
)
